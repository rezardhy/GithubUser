...
import com.reza.submission2bfaa.databinding.FragmentFollowingTabBinding
...
class FollowingTabFragment : Fragment() {
    ...
    companion object {
        ...
        private val TAG = FollowingTabFragment::class.java.simpleName
        private const val ARG_USERNAME = "username"

        @JvmStatic
        fun newInstance(username: String?) =
                FollowingTabFragment().apply {
    ...
    private fun getDataFollowing(){
        ...
        val url = "https://api.github.com/users/$nameUser/following"
            ...
            override fun onSuccess(statusCode: Int, headers: Array<Header>, responseBody: ByteArray) {
                ...
                try {
                    ...
                    if(responseObject.length()==0){
                        _binding!!.zeroFollowingTV.text ="$nameUser tidak megikuti siapapun"
                    }
                    showRecyclerList()
                ...
                _binding!!.progressBarFollowing.isVisible = false
            }
    ...
    private fun showRecyclerList() {
        ...
        _binding?.followingRV?.layoutManager = LinearLayoutManager(activity)
        val listUserAdapter = RVAdapter(list)
        _binding?.followingRV?.adapter = listUserAdapter
